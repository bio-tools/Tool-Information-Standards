...
- *Software Best Practice* can be abstracted from the Curation Guidelines, for example, general recommndations for the description / documentation of software in contexts other than bio.tools.
